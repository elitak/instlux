...
kernels = [ 
	{"distribution":"Linkat","version":"2.0","media":"NET","kernel":"linux","drivers":"initrd","boot_dir":"","boot_dl_dir":"ftp://ftp4.gwdg.de/pub/opensuse/distribution/SL-OSS-factory/inst-source/boot/$ARCH/loader","kernel_append":"devfs=mount,dall ramdisk_size=65536 install=http://download-linkat.xtec.net/distribution/linkat-2.0/inst-source/ server=download-linkat.xtec.net lang=$LangParam splash=silent","icon":"instlux.ico","logo":""},
	{"distribution":"Linkat","version":"2.0","media":"LOCAL","kernel":"linux","drivers":"initrd","boot_dir":"$EXEDIR\\boot\\$ARCH\\loader","boot_dl_dir":"","kernel_append":"devfs=mount,dall ramdisk_size=65536  lang=$LangParam splash=silent","icon":"instlux.ico","logo":""}, 
#	{"distribution":"openSUSE","version":"11.0","media":"NET","kernel":"linux","drivers":"initrd","boot_dir":"","boot_dl_dir":"ftp://ftp4.gwdg.de/pub/opensuse/distribution/SL-OSS-factory/inst-source/boot/$ARCH/loader","kernel_append":"devfs=mount,dall ramdisk_size=65536 install=ftp://ftp4.gwdg.de/pub/opensuse/distribution/SL-OSS-factory/inst-source/ server=ftp4.gwdg.de lang=$LangParam splash=silent","icon":"opensuse.ico","logo":""},
