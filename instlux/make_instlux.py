...
kernels = [ {"distribution":"OpenSuSE","version":"10.3","media":"NET","kernel":"linux","drivers":"initrd","kernel_append":"devfs=mount,dall ramdisk_size=65536 install=http:distribution/SL-OSS-factory/inst-source/ server=195.135.221.130"},{"distribution":"OpenSuSE","version":"10.3","media":"CDROM","kernel":"linux","drivers":"initrd","kernel_append":"devfs=mount,dall ramdisk_size=65536"}, {"distribution":"OpenSuSE_x86_64_","version":"10.3","media":"NET","kernel":"linux","drivers":"initrd","kernel_append":"devfs=mount,dall ramdisk_size=65536 install=http:distribution/SL-OSS-factory/inst-source/ server=195.135.221.130"},{"distribution":"OpenSuSE_x86_64_","version":"10.3","media":"CDROM","kernel":"linux","drivers":"initrd","kernel_append":"devfs=mount,dall ramdisk_size=65536"}]
languages = []
